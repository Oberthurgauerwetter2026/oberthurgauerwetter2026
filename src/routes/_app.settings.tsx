...
function SettingsPage() {
  ...
  const [form, setForm] = useState({
    ...
    models_midterm: "meteoswiss_icon_ch2,icon_d2,ecmwf_ifs025,arpege_europe",
  ...
  async function load() {
    ...
    if (settings) {
      setForm({
        ...
        models_midterm: (settings as any).models_midterm ?? "meteoswiss_icon_ch2,icon_d2,ecmwf_ifs025,arpege_europe",
      ...
      <Card>
        ...
        <CardContent className="grid gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input value={form.models_midterm} onChange={(e) => setForm({ ...form, models_midterm: e.target.value })} placeholder="meteoswiss_icon_ch2,icon_d2,ecmwf_ifs025,arpege_europe" />
          </div>
          <div className="space-y-2">
